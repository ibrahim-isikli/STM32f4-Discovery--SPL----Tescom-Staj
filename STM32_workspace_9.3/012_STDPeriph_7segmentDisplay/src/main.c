...
int main(void)
{
  ...
  while (1)
  {
	...
	case 1:
		...
		break;
	case 2:
		GPIO_SetBits(GPIOA, GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_5 | GPIO_Pin_3 | GPIO_Pin_4);
	...
	case 3:
		...
		break;
	case 4:
		GPIO_SetBits(GPIOA, GPIO_Pin_1 | GPIO_Pin_5 | GPIO_Pin_6| GPIO_Pin_2);
		GPIO_ResetBits(GPIOA, GPIO_Pin_0 | GPIO_Pin_3 | GPIO_Pin_4 );
		break;
	case 5:
		GPIO_SetBits(GPIOA, GPIO_Pin_0 | GPIO_Pin_3 | GPIO_Pin_5 | GPIO_Pin_6);
